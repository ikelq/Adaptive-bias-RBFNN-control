...
print('D:\GE\robot control\04-Adaptive Bias RBF Neural Network Control for ELSs\e_q_bl',...
   '-depsc','-r600')
...
print('D:\GE\robot control\04-Adaptive Bias RBF Neural Network Control for ELSs\T_b_l'...
    ,'-depsc','-r600')


label_y=["Output of RBFNN [N\cdotm]","Error of RBFNN [N\cdotm]"];
legend_y=["RBF_1","RBF_2","error_1","error_2"];
plot_2line(t,TTa',ee_RBF','t [s]',label_y,legend_y,[-14,5;-14,4])
plot_local_detial ([0.2 0.22 0.2 0.2], t,ee_RBF',[90 100])
print('D:\GE\robot control\04-Adaptive Bias RBF Neural Network Control for ELSs\error_bl',...
  '-depsc','-r600')
...
xlabel('t [s]'); ylabel('Output of RBFNN [N]','Position',[-14,7]);
 legend('\tau_1','\tau_2')
 print('Tau_bl','-depsc')
...
legend_y=[""];
plot_2line(t,WW11',Norm_W1','t [s]',label_y,legend_y,[-13,0;-13,3]);
ylabel("\textbf{Norm $\hat{W}$}",'interpreter','latex')

ylabel("\textbf{Evolving $\hat{W}_{700-730}$}",'interpreter','latex')
print('D:\GE\robot control\04-Adaptive Bias RBF Neural Network Control for ELSs\Norm_W1_bl', ...
    '-depsc', '-r600')

plot_line(t,WW11','t [s]',"  ",legend_y,[-20,0])
...
legend_y=[""];
plot_2line(t,WW22',Norm_W2','t [s]',label_y,legend_y,[-13,-0.05;-13,1.5]);
ylabel("\textbf{Norm $\hat{W}$}",'interpreter','latex')

ylabel("\textbf{Evolving $\hat{W}_{700-730}$}",'interpreter','latex')
print('D:\GE\robot control\04-Adaptive Bias RBF Neural Network Control for ELSs\Norm_W2_bl',...
    '-depsc', '-r600')

plot_line(t,WW22','t [s]'," a ",legend_y,[-20,-0.058])
ylabel("\textbf{Evolving $\hat{W}_{700-729}$}",'interpreter','latex','fontsize', 14)
print('D:\GE\robot control\04-Adaptive Bias RBF Neural Network Control for ELSs\Norm_W2_bl',...
    '-depsc', '-r600')
